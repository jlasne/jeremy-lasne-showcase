...
export default function DocumentsPage() {
  // TODO: useQuery(api.documents.listByClient, { clientId }) when Convex is connected
  const documents: Array<{ _id: string; title: string; fileType: string; createdAt: number }> = [];
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 12, color: "#5a5750" }}>
                  {doc.fileType} &middot; {new Date(doc.createdAt).toLocaleDateString()}
                </div>
              </div>
              <button style={{
