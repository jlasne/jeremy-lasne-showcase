    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "100%", maxWidth: 400, padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 600, color: "#e8e6e1", marginBottom: 8 }}>Create Account</h1>
          <p style={{ fontSize: 14, color: "#5a5750" }}>Join the wealth architecture portal</p>
        </div>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "#5a5750", marginTop: 24 }}>
          ...
          <Link href="/sign-in" style={{ color: "#c9a84c", textDecoration: "none" }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
