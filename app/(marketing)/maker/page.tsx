...
const profilePicture = "/images/profile-picture-new.jpg";
const startuphuntLogo = "/images/startuphunt-logo.png";
const trustviewsLogo = "/images/trustviews-logo.png";
const onedollarfeedbackLogo = "/images/onedollarfeedback-logo.png";
...
const logbookEntries: TimelineEntry[] = [
  {
    date: "March 16, 2026",
    title: "Slow day but still worked",
    content:
      "First markets pushed. Reached 21 peoples listed. Testing reddit messaging till go viral. Someone contacted me to be listed !",
  },
  {
    date: "March 15, 2026",
    title: "Start of distribution",
    content:
      "I shared on X, reached out, listed on directories, first reddit post (small community to test messaging). Claude co-work working = my co-founder. Fist disbribution, slow day.",
  },
  {
    date: "March 14, 2026",
          ...
          <div className="lg:col-span-4 xl:col-span-3">
            <div className="lg:fixed lg:top-[120px] lg:w-[calc((100vw-theme(maxWidth.7xl))/2+theme(maxWidth.7xl)*3/12-2rem)] xl:w-[calc((100vw-theme(maxWidth.7xl))/2+theme(maxWidth.7xl)*3/12-2rem)] lg:max-w-[280px]">
              ...
              <p className="text-foreground mb-6 leading-relaxed text-sm md:text-base">
                I build what creates value. I design what preserves it.
              </p>
